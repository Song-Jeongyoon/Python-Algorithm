...
for i in range(n):
    cafeteria_order.insert(i-lotto[i], i + 1)
        
for index in cafeteria_order:
    print(lotto[index], end=' ')
...
for i in range(1, n + 1):
  ...
  if i == 1:
    continue
  for j in range(i, i-data[i-1], -1):
    datas[j-2], datas[j-1] = datas[j-1], datas[j-2]
